const ConectorPluginV3 = (() => {
  ...
  class ConectorPlugin {
    ...
    static URL_PLUGIN_POR_DEFECTO = "http://localhost:5000";
    ...
    async imprimirEn(nombreImpresora: string) {
      ...
      const url = `${this.ruta}/printTicket?printer=${encodeURIComponent(
        'POSPrinter'
      )}&pcname=${encodeURIComponent(
        'LAPTOP-34I0114Q'
      )}&ticket=${encodeURIComponent(1234)}`;
